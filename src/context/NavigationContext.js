...
export const navigation = {
    navList:[
        ...
        {id:"services",title: "usługi", path: "/#services", active: false, serviceActiveToggler: ()=>{}, servicesSub:[
        ...
        {id:"attraction",title: "atrakcje", path: "/#attraction", active: false, attractionActiveToggler: ()=>{}, attractionSub:[
